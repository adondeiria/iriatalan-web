    ...
    >
      ...
      <body className="min-h-full flex flex-col">
        ...
        <footer className="border-t border-zinc-200 dark:border-zinc-800 mt-16">
          <div className="max-w-6xl mx-auto px-6 py-16 grid gap-12 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
            <div>
              <Image
              ...
              />
              <p className="mt-5 text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed max-w-xs">
              ...
              <div className="mt-6 flex items-center gap-4">
                <a
                  ...
                  aria-label="LinkedIn"
                  className="text-zinc-500 hover:text-rif-rojo transition"
                >
            ...
            <div>
              <p className="text-xs uppercase tracking-[0.16em] text-zinc-500 mb-4">Servicios</p>
              <ul className="space-y-3 text-sm text-zinc-700 dark:text-zinc-300">
                <li><Link href="/patrimonial" className="hover:text-zinc-900 dark:hover:text-zinc-50 transition">Protección Patrimonial</Link></li>
                <li><Link href="/gmm" className="hover:text-zinc-900 dark:hover:text-zinc-50 transition">Seguros Personales</Link></li>
                <li><Link href="/retiro" className="hover:text-zinc-900 dark:hover:text-zinc-50 transition">Retiro e Inversiones</Link></li>
                <li><Link href="/hijos-neurodivergentes" className="hover:text-zinc-900 dark:hover:text-zinc-50 transition">Planeación Familiar</Link></li>
                <li><Link href="/empresas" className="hover:text-zinc-900 dark:hover:text-zinc-50 transition">Empresas y Persona Clave</Link></li>
              </ul>
            </div>
            <div>
              <p className="text-xs uppercase tracking-[0.16em] text-zinc-500 mb-4">Recursos</p>
              <ul className="space-y-3 text-sm text-zinc-700 dark:text-zinc-300">
                <li><Link href="/recursos" className="hover:text-zinc-900 dark:hover:text-zinc-50 transition">Recursos para clientes</Link></li>
                <li><Link href="/sobre-iria" className="hover:text-zinc-900 dark:hover:text-zinc-50 transition">Sobre Iria</Link></li>
                <li><Link href="/mexicanos-en-el-extranjero" className="hover:text-zinc-900 dark:hover:text-zinc-50 transition">Mexicanos en el extranjero</Link></li>
                <li><Link href="/aviso-privacidad" className="hover:text-zinc-900 dark:hover:text-zinc-50 transition">Aviso de Privacidad</Link></li>
              </ul>
            </div>
            <div>
              <p className="text-xs uppercase tracking-[0.16em] text-zinc-500 mb-4">Contáctame</p>
              <ul className="space-y-3 text-sm text-zinc-700 dark:text-zinc-300">
                <li>
                  <a
                ...
                <li>
                  <a
                    ...
                    className="hover:text-zinc-900 dark:hover:text-zinc-50 transition break-all"
                  >
