...
const MENSAJE_CONTEXTO =
  "Descargó el Checklist de Protección Patrimonial (hijo con discapacidad).";
const PDF = "/descargas/checklist-proteccion-hijo-discapacidad.pdf";
const XLSX = "/descargas/checklist-proteccion-hijo-discapacidad.xlsx";
    ...
    return (
      <div className="rounded-2xl border border-burgundy/20 bg-cream dark:bg-coffee/40 p-8 text-center">
        ...
        <p className="mt-3 text-warm-brown dark:text-cream-light/80 leading-relaxed">
          Descárgalo en el formato que prefieras. Si al revisarlo detectas algo
          que ordenar, podemos verlo juntos sin compromiso.
        </p>
